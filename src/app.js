...
app.post("/repositories", (request, response) => {
  ...
  // To add a repository to repositories:
...
app.put("/repositories/:id", (request, response) => {
  ...
  if (findRepositoryIndex < 0) {
    return response.status(400).json({ error: 'This repository does not exist, try again!'})
  };
  ...
  // To edit a repository with a given ID:
